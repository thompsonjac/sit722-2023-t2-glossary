...
const itemList = [
  ...
  {'id':41,'title':'Deployment Pipeline',
  'description':'A Deployment Pipeline is an automated process that facilitates the building, testing, and deployment of software changes. There are numerous stages ranging from code commits to production deployment and ensure that each step is executed consistently.',
  'reference':'PagerDuty, Inc, “What is a Deployment Pipeline?,” 2023. [Online]. Available: https://www.pagerduty.com/resources/learn/what-is-a-deployment-pipeline/. [Accessed 6 September 2023].'},
  {'id':42,'title':'Bitbucket',
  'description':'Bitbucket is a web-based platform userd for source code management, version control, and collaborative software development. It offers features like Git and Mercurial repositories, code review tools, and integration with CI/CD pipelines, making it a central hub for code collaboration and automation.',
  'reference':'GeeksforGeeks, “Introduction to BitBucket,” 12 May 2022. [Online]. Available: https://www.geeksforgeeks.org/introduction-to-bitbucket/. [Accessed 6 September 2023].'},
  {'id':43,'title':'Automated Testing',
  'description':'Automated Testing refers to the practice of using testing frameworks and scripts to automatically execute tests on software applications. This ensures that code changes do not introduce defects and maintains the expected functionality of the application.',
  'reference':'M. Rehkopf, “Automated Software Testing,” Atlassian, 2023. [Online]. Available: https://www.atlassian.com/continuous-delivery/software-testing/automated-testing#:~:text=Automated%20testing%20is%20the%20application,include%20automated%20testing%20from%20inception.. [Accessed 6 September 2023].'},
  {'id':44,'title':'Unit Testing',
  'description':'Unit Testing is a development practice where individual components or functions of an application are tested in isolation to verify that they perform correctly and meet design specifications. It helps identify and fix defects at an early stage, contributing to code reliability and maintainability.',
  'reference':'TechTarget, “Unit Testing,” May 2023. [Online]. Available: https://www.techtarget.com/searchsoftwarequality/definition/unit-testing#:~:text=Unit%20testing%20is%20a%20software,tests%20during%20the%20development%20process.. [Accessed 6 September 2023].'},
  {'id':45,'title':'Integration Testing',
  'description':'Integration Testing  is a form of testing that focuses on verifying the interactions and compatibility between different components or modules of an application. It ensures that integrated parts work together, validating that data flows correctly between them and that the overall system behaves as expected.',
  'reference':'J. Schmitt, “Unit testing vs integration testing,” CirclCI Blog, 20 April 2023. [Online]. Available: https://circleci.com/blog/unit-testing-vs-integration-testing/. [Accessed 6 September 2023].'},
  {'id':46,'title':'End-to-end Testing',
  'description':'End-to-end Testing evaluates the complete functionality of an application by simulating real user scenarios. It tests the entire application stack, including user interfaces and backend systems, to identify issues that may affect the user experience.',
  'reference':'S. Bose, “What is End To End Testing?,” BrowserStack, 20 February 2023. [Online]. Available: https://www.browserstack.com/guide/end-to-end-testing#:~:text=End%2Dto%2Dend%20testing%20is%20a%20type%20of%20testing%20that,and%20meets%20the%20user%20requirements.. [Accessed 6 September 2023].'},
  {'id':47,'title':'Regression Testing',
  'description':'Regression Testing checks that new code changes do not introduce new defects or disrupt existing functionality. It involves rerunning previously successful tests to ensure that the applications behaviour remains consistent across different versions or releases.',
  'reference':'S. Daityari, “Regression Testing: A Detailed Guide,” BrowserStack, 24 June 2023. [Online]. Available: https://www.browserstack.com/guide/regression-testing#:~:text=Regression%20Testing%20is%20a%20type,the%20introduction%20of%20new%20changes.. [Accessed 6 September 2023].'},
  {'id':48,'title':'Security Testing',
  'description':'Security Testing involves assessing software applications for vulnerabilities, weaknesses, and compliance with security standards. It aims to identify and remediate security risks, protecting the application and data from threats.',
  'reference':'GeeksForGeeks, “Software Testing | Security Testing,” 28 June 2022. [Online]. Available: https://www.geeksforgeeks.org/software-testing-security-testing/. [Accessed 6 September 2023].'},
  {'id':49,'title':'Jest',
  'description':'Jest is a widely-used JavaScript testing framework in DevOps. It specialises in unit and integration testing of JavaScript and React applications. Jest provides a robust set of testing utilities, including a test runner and assertion library.',
  'reference':'N. Vaidya, “Jest Framework Tutorial: How to use it?,” BrowserStack, 20 February 2023. [Online]. Available: https://www.browserstack.com/guide/jest-framework-tutorial. [Accessed 6 September 2023].'},
  {'id':50,'title':'Monitoring',
  'description':'Monitoring is the continuous process of observing and measuring the performance and health of applications, infrastructure, and services. It involves collecting and analysing data from various sources to detect anomalies, troubleshoot issues, and optimise system performance.',
  'reference':'K. OBrien, “How organizations can successfully measure an application health monitoring process,” IBM, 3 August 2023. [Online]. Available: https://www.ibm.com/blog/application-health-monitoring/. [Accessed 6 September 2023].'},
  {'id':51,'title':'Logging',
  'description':'Logging is the practice of capturing and storing records of events, errors, and activities within an application or system. These logs serve as valuable sources of information for troubleshooting, debugging, auditing, and analysing system behaviour.',
  'reference':'InfoSec Governance Ltd, “Event Logging – Why you should be logging your events,” 2023. [Online]. Available: https://isgovern.com/blog/event-logging-why-you-should-be-logging-your-events/. [Accessed 6 September 2023].'}
]
